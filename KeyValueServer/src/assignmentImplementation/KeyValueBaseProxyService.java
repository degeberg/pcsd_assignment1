...
public class KeyValueBaseProxyService {
    private KeyValueBaseProxyImpl lort;

    @WebMethod
    public void dummy(LengthPredicate p) { }
    
    public KeyValueBaseProxyService() throws IndexOutOfBoundsException, IOException {
        lort = new KeyValueBaseProxyImpl();
    }
